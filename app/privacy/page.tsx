...
export const metadata: Metadata = {
  ...
  description: "How JobsiteQuant handles calculator inputs, saved estimates and projects, analytics, advertising, and feedback reports.",
...
export default function PrivacyPage() {
  return (
    <UtilityContentPage
      ...
      title="Privacy policy"
      intro="JobsiteQuant is designed to calculate locally, request as little information as possible, and explain the data that is stored or processed."
    >
      <h2>Calculator inputs</h2>
      <p>
        Calculator measurements and results are processed in your browser. They
        are not sent to JobsiteQuant&apos;s first-party analytics log. They are sent
      ...
      <p>
        When you submit a report, JobsiteQuant stores the selected calculator,
      ...
      <p>
        JobsiteQuant records limited first-party events such as opening or using
      ...
      <p>
        JobsiteQuant&apos;s first-party analytics log does not store IP addresses,
      ...
      <p>
        If you choose Allow analytics, JobsiteQuant loads Microsoft Clarity to
        understand navigation, clicks, scrolling, session flow, and technical
        friction. Clarity is not loaded before that choice. JobsiteQuant keeps
      ...
      <p>
        ...
        by default. JobsiteQuant also explicitly masks the Project Mode workspace
      ...
      <p>
        JobsiteQuant may use Google AdSense. During AdSense site review, the site
      ...
      <p>
        ...
        serve ads based on a visitor&apos;s prior visits to JobsiteQuant or other
      ...
      <p>
        ...
        Where consent is required, JobsiteQuant will use a Google-certified
