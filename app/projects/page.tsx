...
export const metadata: Metadata = {
  ...
  description:
    "Group estimates saved from JobsiteQuant calculators into local project lists that stay in your browser.",
  alternates: {
    canonical: "/projects",
  },
  robots: {
        ...
        <div className="shell">
          ...
          <div className="calculator-hero-grid">
            <div>
              ...
              <p>
                Combine estimates already saved from different JobsiteQuant
