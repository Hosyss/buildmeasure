...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Mulch bags and bulk deliveries are commonly labeled by volume. BuildNumbers therefore uses the exact bag volume or bulk volume without inventing a density that may change with mulch type, particle size, and moisture.",
  },
  {
...
const schema = [
  {
    ...
    "@type": "WebApplication",
    name: "BuildNumbers Mulch Calculator",
        ...
        <section className="shell calculator-content">
          <article>
            ...
            <p>
              ...
              BuildNumbers calculates its geometric volume first, then keeps
