...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Gravel bulk density changes with stone type, grading, moisture, voids, and whether the material is loose or compacted. A fixed universal density would create false precision, so BuildNumbers exposes the value and lets you replace the planning example with supplier or test data.",
  },
  {
...
const schema = [
  {
    ...
    "@type": "WebApplication",
    name: "BuildNumbers Gravel Calculator",
      ...
      <main className="calculator-page gravel-page">
        ...
        <section className="shell calculator-content">
          <article>
            ...
            <p>
              A rectangular gravel layer is a rectangular prism. BuildNumbers
