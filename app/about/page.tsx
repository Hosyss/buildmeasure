...
export const metadata: Metadata = {
  title: "About JobsiteQuant",
  description:
    "Learn who maintains JobsiteQuant and why its construction and DIY calculators publish transparent, reference-backed estimates.",
...
export default function AboutPage() {
  return (
    <UtilityContentPage
      ...
      intro="JobsiteQuant is an independently developed calculator project, built and maintained by Hosyss, focused on practical material estimates, visible assumptions, and results people can verify before they buy."
    >
      <h2>Who maintains JobsiteQuant</h2>
      <p>
      ...
      <p>
        JobsiteQuant currently provides eight live calculators: concrete slabs,
      ...
      <div className="utility-callout">
        ...
        <p>
          JobsiteQuant expands one verified tool at a time. A planned feature or
      ...
      <p>
        ...
        JobsiteQuant account. That improves privacy, but it also means saved
      ...
      <p>
        JobsiteQuant does not create project plans, inspect site conditions, or
