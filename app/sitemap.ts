...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: absoluteUrl("/post-hole-concrete-calculator"), lastModified: new Date("2026-08-13"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: absoluteUrl("/brick-calculator"), lastModified: new Date("2026-08-13"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: absoluteUrl("/guides/how-many-bags-of-concrete-for-post-holes"), lastModified: new Date("2026-08-13"), changeFrequency: "monthly", priority: 0.8 },
    { url: absoluteUrl("/guides/how-much-paint-do-i-need"), lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: absoluteUrl("/guides/how-many-tiles-do-i-need"), lastModified: new Date("2026-08-11"), changeFrequency: "monthly", priority: 0.8 },
    { url: absoluteUrl("/guides/how-many-bricks-do-i-need"), lastModified: new Date("2026-08-13"), changeFrequency: "monthly", priority: 0.8 },
    { url: absoluteUrl("/guides/how-much-gravel-do-i-need"), lastModified: new Date("2026-08-13"), changeFrequency: "monthly", priority: 0.8 },
