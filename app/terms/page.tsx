...
export const metadata: Metadata = {
  ...
  description:
    "The terms, limitations, and user responsibilities that apply to BuildNumbers estimates.",
...
export default function TermsPage() {
  return (
    <UtilityContentPage
      ...
      intro="BuildNumbers provides planning estimates. Using a calculator does not create project drawings, a supplier quotation, or professional approval."
    >
      <h2>Planning use</h2>
      <p>
        BuildNumbers may be used to estimate material quantities for personal,
      ...
      <p>
        ...
        and package size can vary. BuildNumbers exposes these inputs so they can
      ...
      <p>
        ...
        the published <a href="/methodology">BuildNumbers methodology</a>.
      </p>
    </UtilityContentPage>
  );
}
