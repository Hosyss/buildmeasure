...
export const metadata: Metadata = {
  title: "Contact BuildNumbers",
  description:
    "Contact BuildNumbers about calculator accuracy, privacy, site feedback, or the open-source project.",
...
export default function ContactPage() {
  return (
    <UtilityContentPage
      eyebrow="Contact"
      title="Get in touch with BuildNumbers"
    ...
    >
      ...
      <p>
        BuildNumbers is independently maintained and its source is public. You
        can review the implementation and release history in the{" "}
        <a href="https://github.com/Hosyss/buildmeasure">BuildNumbers repository</a>.
      ...
      <p>
        BuildNumbers provides planning estimates, not project drawings,
