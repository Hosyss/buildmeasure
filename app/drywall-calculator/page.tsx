...
const faqs = [
  { question: "How many drywall sheets do I need?", answer: "Measure the rectangular room length, width, and wall height; choose whether to include the ceiling; subtract the combined measured opening area; and enter the exact sheet size. JobsiteQuant divides the allowance-adjusted area by the sheet area and rounds only the final purchase quantity upward." },
...
const schema = [
  { "@context": "https://schema.org", "@type": "WebApplication", name: "JobsiteQuant Drywall Calculator", url: absoluteUrl("/drywall-calculator"), applicationCategory: "UtilitiesApplication", operatingSystem: "Any", description: "An area-based drywall sheet quantity calculator for rectangular room walls and an optional ceiling.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" } },
