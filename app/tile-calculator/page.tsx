...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "BuildNumbers does not subtract grout area from the purchase quantity. Tile is sold by its face coverage, and a transparent waste allowance handles cuts and loss. Joint width is used only for the row-and-column layout check.",
  },
  {
...
const schema = [
  {
    ...
    "@type": "WebApplication",
    name: "BuildNumbers Tile Calculator",
