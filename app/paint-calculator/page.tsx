...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Sherwin-Williams says a gallon typically covers about 350 to 400 square feet, but coverage changes with the product, texture, porosity, and application method. JobsiteQuant starts at 400 square feet per gallon and lets you replace it with the value on your product label.",
  },
  {
...
const schema = [
  {
    ...
    "@type": "WebApplication",
    name: "JobsiteQuant Paint Calculator",
        ...
        <section className="shell calculator-content">
          <article>
            ...
            <p>
              ...
              selected product. JobsiteQuant keeps the full calculation
