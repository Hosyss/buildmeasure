...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "BIA Technical Note 10 gives at least 5% as a general rule for brick breakage and waste and notes that project conditions or experience may justify a higher percentage. BuildNumbers defaults to 5% but keeps the allowance editable.",
  },
  {
...
const schema = [
  {
    ...
    "@type": "WebApplication",
    name: "BuildNumbers Brick Calculator",
      ...
      <main className="calculator-page brick-page">
        ...
        <section className="shell calculator-content">
          <article>
            ...
            <p>
              BuildNumbers follows the Brick Industry Association wall-area
