        ...
        <section className="utility-page-hero guide-hero">
          <div className="shell">
            ...
            <div className="guide-meta">
              ...
              <span>Reviewed against the JobsiteQuant calculation standard</span>
            </div>
          </div>
        </section>
        ...
        <article className="shell guide-article">
          ...
          <div className="guide-body">
            ...
            <section id="measure">
              ...
              <div className="guide-rule">
                ...
                <p>
                  ...
                  Four inches is one-third of a foot, not 0.4 ft. JobsiteQuant
            ...
            <div className="utility-callout">
              ...
              <p>
                Read the <a href="/methodology">JobsiteQuant methodology</a> for
