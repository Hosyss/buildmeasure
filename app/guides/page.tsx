...
export const metadata: Metadata = {
  ...
  description: "Practical, reference-backed guides for multi-shape concrete projects, rectangular and circular concrete slabs, footings, columns, walls, drywall, paint, tile, brick, gravel, and mulch before using a material calculator.",
  alternates: { canonical: "/guides" },
};

const guides = [
  ["Concrete projects", "How do I estimate a multi-shape concrete project?", "Combine slabs, circular pours, footings, columns, walls, and post holes by adding unrounded physical volume first, then apply one project allowance and round bags once.", "/guides/how-to-estimate-multi-shape-concrete-project"],
  ["Concrete slabs", "How many bags of concrete do I need?", "Measure a rectangular slab, convert volume, compare ready-mix and bag quantities, and keep waste visible.", "/guides/how-many-bags-of-concrete"],
  ["Circular concrete", "How much concrete do I need for a circular slab?", "Turn diameter into radius and circle area, multiply by actual depth, combine identical pours, and round complete bags once.", "/guides/how-much-concrete-for-circular-slabs"],
  ...
  ["Concrete walls", "How much concrete do I need for a wall?", "Subtract measured full-depth openings, multiply net wall face area by actual thickness, and keep structural sizing out of the quantity estimate.", "/guides/how-much-concrete-for-walls"],
