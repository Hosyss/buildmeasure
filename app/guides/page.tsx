...
export const metadata: Metadata = {
  ...
  description: "Practical, reference-backed guides for measuring rectangular and circular concrete slabs, footings, columns, walls, drywall, paint, tile, brick, gravel, and mulch before using a material calculator.",
