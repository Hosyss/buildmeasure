...
export const metadata: Metadata = {
  ...
  description: "Practical, reference-backed guides for measuring concrete, footings, drywall, paint, tile, brick, gravel, and mulch before using a material calculator.",
