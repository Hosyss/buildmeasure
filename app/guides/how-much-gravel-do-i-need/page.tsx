          ...
          <div className="guide-body">
            ...
            <section id="density">
              ...
              <p>
                ...
                matches the watershed. JobsiteQuant exposes the value instead of
            ...
            <div className="utility-callout">
              ...
              <p>
                Open the <a href="/gravel-calculator">JobsiteQuant Gravel Calculator</a> and replace the example density with supplier data.
              </p>
            </div>
          </div>
        </article>
