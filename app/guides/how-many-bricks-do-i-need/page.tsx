...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "BIA Technical Note 10 gives at least 5% as a general rule for brick breakage and waste and notes that project conditions or experience can justify more. JobsiteQuant keeps the allowance explicit rather than assuming one percentage fits every job.",
  },
  {
    question: "Does this method include mortar?",
    answer:
      "No. This guide estimates fired-clay brick quantity only. It does not estimate mortar or grout. The BIA coverage presets already represent documented wall-area estimating quantities; JobsiteQuant does not add a separate invented mortar-volume calculation to this guide.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Not as a verified JobsiteQuant assumption. BIA states that its Technical Notes are based on fired-clay brick and should not be assumed to apply to concrete, fly-ash, or other non-clay units. Use product- and project-specific data for those materials.",
  },
];
        ...
        <article className="shell guide-article">
          ...
          <div className="guide-body">
            ...
            <section id="formula">
              ...
              <p>
                JobsiteQuant keeps the exact net quantity unrounded internally.
            ...
            <section id="openings">
              ...
              <p>
                The JobsiteQuant calculator accepts one combined openings-area
            ...
            <section id="waste">
              ...
              <p>
                ...
                percentage. JobsiteQuant therefore defaults to 5% but leaves the
                value editable.
              </p>
              <p>
            ...
            <div className="utility-callout">
              ...
              <p>
                Open the <a href="/brick-calculator">JobsiteQuant Brick Calculator</a> for BIA presets, a custom supplier/project coverage rate, waste allowance, metric/imperial inputs, whole-brick order rounding, and optional user-entered price per brick.
              </p>
            </div>
