...
test("privacy page documents local projects, analytics, and AdSense disclosures", async () => {
  ...
  assert.match(html, /not synchronized to an account or sent to BuildNumbers/);
  ...
  assert.match(html, /other third-party vendors or ad networks participating through AdSense/i);
