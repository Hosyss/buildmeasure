...
test("homepage workflow anchor clears the sticky site header", async () => {
  ...
  assert.match(
    anchorCss,
    /#how-it-works\s*\{[\s\S]*?scroll-margin-top\s*:\s*140px\s*;/,
    "the How it works anchor must land below the sticky utility and navigation rows",
  );
});
