...
BuildNumbers reports two progress figures so a short-term launch target is not
...
- Cloudflare Production: `https://buildnumbers.pages.dev/`.
...
- Production verification at
  `https://buildnumbers.pages.dev/brick-calculator` confirmed the
