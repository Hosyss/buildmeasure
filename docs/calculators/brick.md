...
The BIA table also prints rounded metric rates per 10 m². BuildNumbers stores
...
percentage. BuildNumbers therefore defaults to 5% but keeps the value explicit
